...
public class NotesConfigDialog extends JDialog implements DocumentListener {
    ...
    public NotesConfigDialog() {
        super(null, "Notes Analysis Configuration", Dialog.ModalityType.APPLICATION_MODAL);
    }

    NotesConfigDialog(ProjectOrganization organization) {
        super(null, "Notes Analysis Configuration", Dialog.ModalityType.APPLICATION_MODAL);
        org = organization;
